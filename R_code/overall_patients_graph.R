...
write.table(gene.Matrix,"~/Desktop/FINAL_FYT/gene.matrix.txt",row.names = F, sep = '\t')
...
ggsave(file="~/Desktop/FINAL_FYT/Figure1_mutation_landscape_based_on_mutation_type.pdf", plot=figure_1,bg = 'white', width = 40, height = 33, units = 'cm', dpi = 600)

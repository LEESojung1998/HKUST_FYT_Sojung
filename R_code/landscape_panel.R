...
#raw_data_interaction <- read.delim("~/Desktop/secondsem/final+result/region_sum/FINAL_TEDGedge.modified_simplfied.txt")
#### region_sum
...
write.table(traj.Matrix,"~/Desktop/FINAL_FYT/region_num/traj.matrix.txt",row.names = F, sep = '\t')
...
grid.draw(figure_1)
ggsave(file="~/Desktop/secondsem/final+result/Figure4_mutation_landscape_simplfied.pdf", plot=figure_1,bg = 'white', width = 40, height = 33, units = 'cm', dpi = 600)
ggsave(file="~/Desktop/FINAL_FYT/region_num/Figure7-2_mutation_landscape_simplfied.pdf", plot=figure_1,bg = 'white', width = 40, height = 33, units = 'cm', dpi = 600)
...
grid.draw(figure_2)
ggsave(file="~/Desktop/FINAL_FYT/region_num/Figure7-1_mutation_landscape_remove_bar.pdf", plot=figure_2,bg = 'white', width = 40, height = 33, units = 'cm', dpi = 600)
...
grid.draw(figure_3)
ggsave(file="~/Desktop/FINAL_FYT/region_num/Figure7_mutation_landscape_clonal.pdf", plot=figure_3,bg = 'white', width = 40, height = 33, units = 'cm', dpi = 600)
